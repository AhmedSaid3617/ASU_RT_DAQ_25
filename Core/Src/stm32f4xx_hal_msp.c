...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    GPIO_InitStruct.Pin = SUS_1_Pin|SUS_2_Pin|Pressure_1_Pin|Pressure_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SUS_3_Pin|SUS_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOC, SUS_1_Pin|SUS_2_Pin|Pressure_1_Pin|Pressure_2_Pin);

    HAL_GPIO_DeInit(GPIOA, SUS_3_Pin|SUS_4_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = REAR_RIGHT_WHEEL_Pin|FRONT_LEFT_WHEEL_Pin|REAR_LEFT_WHEEL_Pin|FRONT_RIGHT_WHEEL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOA, REAR_RIGHT_WHEEL_Pin|FRONT_LEFT_WHEEL_Pin|REAR_LEFT_WHEEL_Pin|FRONT_RIGHT_WHEEL_Pin);
